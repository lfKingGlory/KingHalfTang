...
@implementation MSHomeCell

+ (MSHomeCell *)cellWithTableView:(UITableView *)tableView {
    MSHomeCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MSHomeCell"];
    if (!cell) {
        cell = [[MSHomeCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MSHomeCell"];
...
- (void)setModel:(MSHalfTangModel *)model {
    _model = model;
